    ...
    <div className="fixed z-50 w-full ">
      ...
      <div className="flex justify-center gap-5 py-5">
        <div className="flex gap-1">
          ...
          <div className= 'text-[12px] text-white'>info@example.com</div>
        </div>
        <div className="flex gap-1">
          <div >
            {" "}
          ...
          <div className=' text-[12px]  text-white'> Open hours: Sun-fri- 10.00am to 8.00pm</div>
        </div>
      </div>
        
      </div>
      <div>
      <div className=" bg-[#0e0e0e87] justify-between ">
          <div className=" mx-auto max-w-6xl justify-between flex flex-col-1 items-center py-2">
              <div>
                <svg
              ...
              <div className=" flex text-white gap-6 text-[12px] ">
                <Link href="/home">Home</Link>
                <Link href="/home">Menu</Link>
                <Link href="/home">Order</Link>
                <Link href="/home">Order</Link>
              ...
              <ul className="flex gap-7 items-center">
                ...
                <li className=" text-orange-700 px-3 py-2 text-[12px] border border-orange-700"> Find a Table</li>
              </ul>
          </div>
        </div>
      </div>
